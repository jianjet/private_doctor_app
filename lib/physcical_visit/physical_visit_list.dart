...
class PhysicalVisitList extends StatefulWidget {
  String patient_name;
  String service;
  ...
  @override
  State<PhysicalVisitList> createState() => PhysicalVisitListState();
}

class PhysicalVisitListState extends State<PhysicalVisitList> {
  ...
  Future _appointmentConfirmed() async {
    try {
      await firestore.collection('physical_visit_server').doc(widget.document_id).update({
        'rated': false,
        'booking_status': true,
      });
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            const SizedBox(height: 4),
                            Text(widget.address, maxLines: 3, style: TextStyle(fontSize: 13,color: Colors.grey.shade600, fontWeight: FontWeight.normal),),
                          ],
                        ),
                      ),
                    ),
